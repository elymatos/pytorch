"""
Test script for the HTPC AND-OR Graph Builder implementation.
"""
from htpc_graph_builder import HTCPGraphBuilder


def main():
    # Create a builder instance with debug mode
    ...
    builder.thresholds = {
        ...
        "hierarchy": 1,  # Minimum frequency for hierarchy (lowered for testing)
        "discourse": 1  # Minimum frequency for discourse (lowered for testing)
    }
